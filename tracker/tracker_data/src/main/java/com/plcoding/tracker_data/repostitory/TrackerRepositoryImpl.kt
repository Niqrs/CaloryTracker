package com.plcoding.tracker_data.repostitory
...
class TrackerRepositoryImpl(
            ...
            Result.success(
                searchDto.products
                    .filter {
                        ...
                        val lowerBound = calculatedCalories * 0.93f
                        val upperBound = calculatedCalories * 1.07f
    ...
    override suspend fun insertTrackedFood(food: TrackedFood) {
        dao.insertTrackedFood(
            trackedFoodEntity = food.toTrackedFoodEntity()
        )
    }

    override suspend fun deleteTrackedFood(food: TrackedFood) {
        dao.deleteTrackedFood(
            trackedFoodEntity = food.toTrackedFoodEntity()
        )
    }
